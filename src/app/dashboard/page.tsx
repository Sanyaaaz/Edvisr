      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-400 text-sm">Wednesday, March 26, 2025</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 bg-white/10 p-8 rounded-2xl shadow-lg hover:shadow-purple-500/30 transition-shadow">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="p-4 rounded-xl bg-[#2A2A33] border-l-4 border-[#8B79F9]">
          ...
          <div className="bg-white/10 p-8 rounded-2xl shadow-lg hover:shadow-purple-500/30 transition-shadow">
            ...
            <div className="space-y-4">
              <div className="bg-[#3A2F1F] p-4 rounded-lg border-l-4 border-pink-500">
                <h3 className="font-semibold text-white">Create a landing page in Figma</h3>
                <p className="text-sm text-gray-400">Due: Tomorrow</p>
                <p className="text-xs mt-1 text-gray-500">Assigned to 34 students</p>
              </div>
              <div className="bg-[#1F332C] p-4 rounded-lg border-l-4 border-purple-500">
                <h3 className="font-semibold text-white">Revise UI Heuristics</h3>
                <p className="text-sm text-gray-400">Due: Friday</p>
                <p className="text-xs mt-1 text-gray-500">Assigned to 29 students</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/10 p-8 rounded-2xl shadow-lg hover:shadow-purple-500/30 transition-shadow">
              ...
              <div className="space-y-3">
                <div className="bg-[#2B2B33] p-3 rounded-lg hover:bg-[#3A3A44] transition">
                  ...
                  <p className="text-sm text-gray-400">5 Modules · 32 Students</p>
                </div>
                <div className="bg-[#2B2B33] p-3 rounded-lg hover:bg-[#3A3A44] transition">
                  <p className="font-medium text-white">Product Design 101</p>
                  <p className="text-sm text-gray-400">4 Modules · 28 Students</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/10 p-8 rounded-2xl shadow-lg hover:shadow-purple-500/30 transition-shadow">
            ...
            <div className="space-y-4">
              {["James", "Tina", "Ravi"].map((name, idx) => (
                <div key={idx} className="bg-[#2B2B33] p-3 rounded-md hover:bg-[#3B3B45] transition">
